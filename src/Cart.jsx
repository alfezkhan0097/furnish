              ...
              <div className="group bg-white/10 rounded-lg shadow-md overflow-hidden">
                <div className="h-56 overflow-hidden">
                  <img
                    src={item.image}
                    alt={item.title}
                    className="w-full h-56 group-hover:scale-[1.1] transition-transform object-cover"
                  />
                </div>
                <div className="p-4">
                  ...
                  <button
                    onClick={() => removeFromCart(index)}
                    className="w-full px-4 py-2 font-semibold bg-white/20 text-white hover:text-neutral-800 rounded-lg hover:bg-red-500/9 0"
                  >
                    Remove
                  </button>
                </div>
