...
const HeroWithPagination = () => {
  ...
  return (
    ...
    >
      <div className={`container mx-auto h-full flex flex-col items-end mt-24 text-white`}>
        <h1 className={`text-4xl font-bold mb-4 ${slides[currentSlide].color}`}>{slides[currentSlide].title}</h1>
        <a
          href="/shop"
