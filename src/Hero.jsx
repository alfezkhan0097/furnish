...
const Hero = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      left: "left-[-25%]",
      description: "Get the best deals on stylish and comfortable bedroom sets.",
      imageUrl:
    ...
    },
    {
      ...
      left: "left-[-12%]",
      description: "Upgrade your workspace with modern and ergonomic furniture.",
      imageUrl:
  ...
  return (
    ...
    >
      <div className={`absolute ${slides[currentSlide].left} top-[-10%] transition-all duration-300 container mx-auto h-full flex flex-col justify-center items-center text-center text-white`}>
      ...
      <button
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="translate-x-[15%]" height="20px" viewBox="0 -960 960 960" width="20px" fill="#e8eaed"><path d="M384-96 0-480l384-384 68 68-316 316 316 316-68 68Z"/></svg>
          </button>
          <button
            onClick={nextSlide}
