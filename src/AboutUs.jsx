...
const AboutUs = () => {
  return (
    <section id="us" className="container mx-auto py-16 px-4 md:px-0">
      <div className="mb-12">
        <h2 className="text-center text-4xl font-bold mb-4 border-b-2 border-yellow-400 w-max mx-auto">
          About Us
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-xl font-semibold mb-2 border-b-2 border-yellow-400 w-max mx-auto">
            Our Mission
          </h3>
